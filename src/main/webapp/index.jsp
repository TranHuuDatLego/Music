                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="300ms">Temporal Transcendence <span>Temporal
                                        Transcendence</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="discovery.jsp"
                                    class="btn oneMusic-btn mt-50">Discover <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                            ...
                            <%-- <div class="album-price">--%>
                                <%-- <p>$0.90</p>--%>
                                    <%-- </div>--%>
                                        <!-- Play Icon -->
                                        <%-- <div class="play-icon">--%>
                                            <%-- <a href="audio/htca.mp3" class="video--play--btn"><span
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow fadeInUp" data-wow-delay="500ms">
                        <div class="album-thumb">
                            ...
                            <!-- Play Icon -->
                            <%-- <div class="play-icon">--%>
                                <%-- <a href="audio/mojito.mp3" class="video--play--btn"><span
                                        class="icon-play-button"></span></a>--%>
                                    <%-- </div>--%>
                        </div>
                        <div class="album-info">
