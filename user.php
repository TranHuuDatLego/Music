                  ...
                  <div class="row">
                     <div class="col-12">
                           <div class="hero-slides-content text-center">
                              ...
                              <a data-animation="fadeInUp" data-delay="500ms" href="discovery.php" class="btn oneMusic-btn mt-50">Discover <i class="fa fa-angle-double-right"></i></a>
                           </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="row d-flex flex-wrap align-items-center">
               <div class="col-12 col-md-6">
                  <p class="copywrite-text">
                     <a href="index.php" >Copyright &copy; 2024 All rights reserved</a>
                  </p>
               </div>
         </div>
      </div>
